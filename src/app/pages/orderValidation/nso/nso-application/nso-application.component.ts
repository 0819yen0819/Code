...
@Component({
  selector: 'app-nso-application',
  templateUrl: './nso-application.component.html',
  styleUrls: ['./nso-application.component.scss']
})
export class NsoApplicationComponent implements OnInit,OnChanges {
  @Input() formInfo: any = {};
