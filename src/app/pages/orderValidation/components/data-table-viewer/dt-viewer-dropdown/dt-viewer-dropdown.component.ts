...
@Component({
  selector: 'sov-app-dt-viewer-dropdown',
  templateUrl: './sov-dt-viewer-dropdown.component.html',
  styleUrls: ['./sov-dt-viewer-dropdown.component.scss'],
})
export class SovDtViewerDropdownComponent implements OnInit {
