...
@Component({
  selector: 'sov-app-common-data-table-viewer',
  templateUrl: './sov-data-table-viewer.component.html',
  styleUrls: ['./sov-data-table-viewer.component.scss'],
})
export class SovDataTableViewerComponent implements OnInit, OnChanges, OnDestroy {
