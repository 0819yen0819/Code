...
@Component({
  selector: 'check-result-download',
  templateUrl: './check-result-download.component.html',
  styleUrls: ['./check-result-download.component.scss'],
})
export class CheckResultDownloadComponent implements OnInit, OnDestroy {
