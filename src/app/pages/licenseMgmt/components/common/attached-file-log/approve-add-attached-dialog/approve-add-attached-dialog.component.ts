...
@Component({
  selector: 'app-common-approve-add-attached-dialog',
  templateUrl: './approve-add-attached-dialog.component.html',
  styleUrls: ['./approve-add-attached-dialog.component.scss'],
})
export class ApproveAttachedDialogComponent implements OnInit, OnChanges {
