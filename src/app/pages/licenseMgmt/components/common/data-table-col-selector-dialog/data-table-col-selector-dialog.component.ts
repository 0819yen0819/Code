...
@Component({
  selector: 'app-common-data-table-col-selector',
  templateUrl: './data-table-col-selector-dialog.component.html',
  styleUrls: ['./data-table-col-selector-dialog.component.scss'],
})
export class DataTableColSelectorComponent implements OnInit, OnChanges {
